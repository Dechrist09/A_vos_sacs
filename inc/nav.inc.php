...
<head>
     ...
     <meta name="description" content="Premier site en PHP : site avec la BDD sacs">
          ...
          <nav class="navbar navbar-expand-lg fixed-top bg-danger">
               <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="<?= RACINE_SITE ?>index.php">
                         <img src="<?= RACINE_SITE ?>assets/img/Store1 Logo.png" alt="image-logo" height="100vh" width="100"></a>
                         ...
                         <ul class="navbar-nav w-100 d-flex justify-content-between">
                              ...
                              <?php } else { ?>
                                   ...
                                   <?php if ($_SESSION['user']['role'] == 'ROLE_ADMIN') { ?>
                                        ...
                                        <li class="nav-item">
                                             <a class="nav-link"
                                                  href="<?= RACINE_SITE ?>admin/dashboard.php?dashboard.php">Backoffice</a>
                                        </li>
