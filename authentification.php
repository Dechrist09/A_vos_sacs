...
$metaDescription ="Bienvenue sur la page authentification, connectez-vous svp";
...
<main style="background:url(assets/img/5818.png) no-repeat; background-size: cover; background-attachment: fixed;" class="pt-5 mt-5">
    ...
    <div class="w-75 m-auto p-5" style="background: rgba(20, 20, 20, 0.9);">
        <h1 class="text-center text-white p-3 mb-5"> Veuillez vous Connecter</h1>
        ...
        <form action="" method="post" class="p-5">
            <div class="row mb-3">
                ...
                <div class="col-12 mb-5">
                    ...
                    <input type="checkbox" onclick="showPass()"> <span class="text-danger">
                    Afficher/masquer le mot de passe</span>
                </div>
